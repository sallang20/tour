$(function () {
  ...
  const ul3 = $("#con2 ul:nth-of-type(2)").offset().top + baseline1;
  ...
  $(window).on("scroll", function () {
    ...
    // let ul1 = $("#con2 ul:nth-of-type(1)").offset().top + baseline;
    // let ul2 = $("#con2 ul:nth-of-type(2)").offset().top + baseline;
    // let ul3 = $("#con2 ul:nth-of-type(3)").offset().top + baseline;
